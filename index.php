...
<head>
<title>Special For Diana Asmarani Siregar</title>
</head>
<style>
...
body::before{content:"\00A9  (Special For Diana)";padding:8px;border-radius:12px;background:black;color:white;opacity:.7;font-size:9px;position:fixed;bottom:20px;left:20px;z-index:999}
...
<body>
	...
	<audio src="https://sikepal.my.id/judika.mp3" id="linkmp3" class="sembunyi"></audio>
   ...
   <p id="ket">Coba kirim video ini ke pasanganmu <3</p>
   <div><div id="loveIn" class="awalan">
     ...
     <label>S.id/akusangat</label>
   </div></div>

   <!-- Foto Atas --><div><img id="fotosatu" src=""/><img id="fotodua" src=""/><img id="fototiga" src=""/><img id="fotoempat" src=""/><img id="fotolima" src=""/><img id="fotoenam" src=""/><img id="fototujuh" src=""/><img id="fotodelapan" src=""/><img id="fotosembilan" src=""/></div>
   ...
   <!-- Tombol Kirim Pesan -->
   <div id="contTom">
      <a id="By" class='button' onClick="jawab_y()">💌 Rindu</a>
      <a id="Bn" class='button' onClick="jawab_n()">Engga</a>
   </div>
...
<!-- Jangan Edit Bagian Ini --><script>
  ...
  fkata=1;function gantikata(){
        ...
        if(fkata==3){kalimat.innerHTML="";displayText();}
...
<script type="text/javascript">
  ...
  function pergantian(){
      setTimeout(gantikata,700); //1
      setTimeout(gantikata,2900); //2
      setTimeout(gantikata,5600); //3
      
  }
  
      async function pertama(){
         kata1 = "Aku Sangat Bersyukur<br>Punya Kamu 👉👈";
         kata2 = "Dan Aku Bahagia Bisa<br>Kenal Sama Kamu..";
         perkata = ["Makasih ya", "Udah", "Jadi", "Sosok", "Terbaik", "di Hidupku"];
         emot = "😍🥰🫶🫰💗";
         
         pesanjawab_y = "Yeaayy! Maacii sayaangggkuu 😍❤️";
         pesanjawab_n = "Yaahh ko gitu sih 🫠";
         
         fotosatu.style="display:inline-flex";audio.play();showDiv()
       } 
       
  function loadfoto(){
    wallpaper.src = "https://i.ibb.co/cDTzVV6/8e22e0b30d7f29e7c7f1e84cf2fa931b.jpg";
    
    gambar1 = "https://feeldreams.github.io/pandahiya.gif";
    gambar2 = "https://feeldreams.github.io/pusn.gif";
    gambar3 = "https://feeldreams.github.io/mmua.gif";
    /*gambar4 = "https://feeldreams.github.io/emawh.gif";
    gambar5 = "https://feeldreams.github.io/pandahiya.gif";
    gambar6 = "https://feeldreams.github.io/pusn.gif";
    gambar7 = "https://feeldreams.github.io/mmua.gif";
    gambar8 = "https://feeldreams.github.io/lompatin.gif";
    gambar9 = "https://feeldreams.github.io/pandaberi.gif";
    */
    stikerpesanjawab_y = "https://feeldreams.github.io/pandapanah.gif";
    stikerpesanjawab_n = "https://feeldreams.github.io/ngumpet.gif";

    loadbrn();
  }

async function ptawal(){
var { isConfirmed: tny } = await swals.fire({
    title: 'Yakin Mau Lihat 😋?',
    confirmButtonText: 'Lanjut',
    
    showCancelButton: true,
});
if(!tny){
  window.location.replace("https://web.feeldream.repl.co/");
}
  }
    setTimeout(ptawal,500);
</script>
</body>
</html>
